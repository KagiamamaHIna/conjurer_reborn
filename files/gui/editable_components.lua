...
conjurer_reborn_editwand_active_field = conjurer_reborn_editwand_active_field or nil
...
function NumberField(field_name, min, max, default, multiplier, tooltip, text, comp_id, ddist, decimals, vec2_index)
  local global_name = "conjurer_reborn_NUMBERFIELD_"..field_name.."_"..tostring(vec2_index).."_"..ComponentGetTypeName(comp_id)
      ...
      Button(
        {
          ...
          image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_number_input.png"
        },
        function()
