...
dofile_once("mods/conjurer_reborn/files/wands/editwand/helpers.lua");
dofile_once("mods/conjurer_reborn/files/wands/wand_utilities.lua");
dofile_once("mods/conjurer_reborn/files/gui/editable_components.lua")
  ...
  Background({margin=3, style=NPBG_DEFAULT, z_index=200, min_width=90}, function()
    Vertical(1, 1, function()
      Horizontal(0, 0, function()
        Image({sprite="mods/conjurer_reborn/files/gfx/editwand_icons/info_position.png", tooltip="Position"})
        Text(math.floor(x)..", "..math.floor(y), {tooltip="Position", x=2})
      end)
      Horizontal(0, 0, function()
        Image({sprite="mods/conjurer_reborn/files/gfx/editwand_icons/info_rotation.png", tooltip="Rotation"})
        Text(string.format("%.4f", rot), {tooltip="Rotation (rad)", x=2})
      end)
      Horizontal(0, 0, function()
        Image({sprite="mods/conjurer_reborn/files/gfx/editwand_icons/info_scale.png", tooltip="Scale"})
        Text(string.format("%.2f", scale_x)..", "..string.format("%.2f", scale_y), {tooltip="Scale", x=2})
      end)

      Horizontal(0, 0, function()
        Image({sprite="mods/conjurer_reborn/files/gfx/editwand_icons/info_xml.png", tooltip="Tags & XML"})
        HoverText(filepath .."\n"..tags_text, {x=2})
      end)
      ...
      if is_physical_entity(entity) then
        ...
        Horizontal(0, -2, function()
          Button(
            {x=11, y=12, tooltip="Rotation -0.5 degrees", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_arrow_left_cycle_small.png"},
            function() EntitySetTransform(entity, x, y, rot-math.rad(0.5), scale_x, scale_y) end
          )
          Button(
            {x=12, y=12, tooltip="Rotation +0.5 degrees", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_arrow_right_cycle_small.png"},
            function() EntitySetTransform(entity, x, y, rot+math.rad(0.5), scale_x, scale_y) end
          )
        end)
        Horizontal(0, 0, function()
          Button(
            {tooltip="Rotation -90 degrees", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_arrow_left_cycle.png"},
            function() EntitySetTransform(entity, x, y, rot-math.rad(90), scale_x, scale_y) end
          )
          Button(
            {tooltip="Y-Pos -1.0", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_arrow_up.png"},
            function() EntitySetTransform(entity, x, y-1, rot, scale_x, scale_y) end
          )
          Button(
            {tooltip="Rotation +90 degrees", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_arrow_right_cycle.png"},
            function() EntitySetTransform(entity, x, y, rot+math.rad(90), scale_x, scale_y) end
          )
        end)
        Horizontal(0, 0, function()
          Button(
            {tooltip="X-Pos -1.0", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_arrow_left.png"},
            function() EntitySetTransform(entity, x-1, y, rot, scale_x, scale_y) end
          )
          Button(
            {tooltip="Y-Pos +1.0", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_arrow_down.png"},
            function() EntitySetTransform(entity, x, y+1, rot, scale_x, scale_y) end
          )
          Button(
            {tooltip="X-Pos +1.0", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_arrow_right.png"},
            function() EntitySetTransform(entity, x+1, y, rot, scale_x, scale_y) end
          )
        end)
        ...
        Horizontal(0, 0, function()
          Vertical(0, 1, function()
            Button(
              {x=1, y=-3, tooltip="Scale +0.1", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_plus_small.png"},
              function()
                EntitySetTransform(entity, x, y, rot, incr(scale_x, 0.1), incr(scale_y, 0.1))
              end
            )
            Button(
              {x=1, y=1, tooltip="Scale +0.01", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_plus_small.png"},
              function()
          ...
          Button(
            {x=3, tooltip="Scale +0.5", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_plus.png"},
            function()
              EntitySetTransform(entity, x, y, rot, incr(scale_x, 0.5), incr(scale_y, 0.5))
            end
          )
          Button(
            {x=-1, tooltip="Scale -0.5", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_minus.png"},
            function()
          ...
          Vertical(0, 1, function()
            Button(
              {y=-3, tooltip="Scale -0.1", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_minus_small.png"},
              function()
                EntitySetTransform(entity, x, y, rot, decr(scale_x, 0.1), decr(scale_y, 0.1))
              end
            )
            Button(
              {y=1, tooltip="Scale -0.01", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_minus_small.png"},
              function()
        ...
        Horizontal(0, 3, function()
          Button(
            {tooltip="Flip horizontally", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_arrow_horizontal.png"},
            function() EntitySetTransform(entity, x, y, rot, scale_x*-1, scale_y) end
          )
          Button(
            {x=-1, tooltip="Flip vertically", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_arrow_vertical.png"},
            function() EntitySetTransform(entity, x, y, rot, scale_x, scale_y*-1) end
          )
          Button(
            {x=1, y=1, tooltip="Reset rotation & scale", image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_reset_3.png"},
      ...
      Vertical(0, 0, function()
        Horizontal(0, 0, function()
            ...
            Button(
              {
                ...
                image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_kill.png",
              },
              function()
          ...
          Button(
            {
              ...
              image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_del.png",
            },
            function()
              EntityKill(entity)
              GlobalsSetValue(SIGNAL_RESET_EDITWAND_GUI, "1")
          ...
          if name ~= "conjurer_reborn_background" then
            Button(
              {
                tooltip="Clone entity",
                tooltip_desc="Only a pure copy is made, no modifications are preserved.",
                image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_cln.png",
              },
              function()
            ...
            Button(
              {
                ...
                image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_sav.png",
              },
              function()
        ...
        if hitboxes then
          local hitbox_sprites = EntityGetComponentIncludingDisabled(entity, "SpriteComponent", "conjurer_reborn_hitbox_display")
          local hitbox_updater = EntityGetFirstComponentIncludingDisabled(entity, "LuaComponent", "conjurer_reborn_hitbox_updater")
...
function render_editwand_buttons()
  ...
  Background({margin=1, z_index=200}, function()
    Button(
      {
        ...
        image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_entity_properties.png",
        padding=0,
      },
      function()
    ...
    Button(
      {
        tooltip="Components",
        image="mods/conjurer_reborn/files/gfx/editwand_icons/icon_component_list.png",
        padding=0,
      },
      function()
      ...
      for i, item in ipairs(valid_comps) do
        if item.not_supported then
          ...
          local click = function()
            ...
            conjurer_reborn_editwand_active_field = nil
...
function render_editwand()
  ...
  if active_entity and EntityGetIsAlive(active_entity) and render_active_editwand_overlay == nil then
    ...
    for c, comp in ipairs(comps) do
      if not ComponentHasTag(comp, "conjurer_reborn_hitbox_display") then
  ...
  if render_active_editwand_overlay ~= nil and active_entity and EntityGetIsAlive(active_entity) then
    ...
    if conjurer_reborn_editwand_active_field then
      Vertical(detail_menu_pos_x, detail_menu_pos_y, function()
        render_detail_menu(conjurer_reborn_editwand_active_field)
      end)
    end
  end
end
