dofile_once("mods/conjurer_reborn/files/scripts/lists/entity_categories.lua");
...
ICON_DELETE_ENTITY = "mods/conjurer_reborn/files/gfx/entwand_icons/icon_delete_entity.png"
ICON_STAFF_OPTIONS = "mods/conjurer_reborn/files/gfx/entwand_icons/icon_entity_staff_options.png"
