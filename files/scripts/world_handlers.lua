...
local BIOMES = {
  {
    biome_filename="mods/conjurer_reborn/files/biomes/takapiha.xml",
    height_index="0",
    color="ffc0ff33",
  },
  {
    biome_filename="mods/conjurer_reborn/files/biomes/forest_nocaves.xml",
    height_index="0",
    color="ffc4ff33",
  },
  {
    biome_filename="mods/conjurer_reborn/files/biomes/forest_pond.xml",
    height_index="0",
    color="ff0220ff",
  },
  {
...
function replace_pixel_scenes()
  ...
  local conjurer_scenes = ModTextFileGetContent("mods/conjurer_reborn/files/overrides/_pixel_scenes.xml")
...
function replace_biome_map()
  ModMagicNumbersFileAdd("mods/conjurer_reborn/files/overrides/map_conjurer.xml")
end
