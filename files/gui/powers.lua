...
dofile_once("mods/conjurer_reborn/files/powers/toggle_speed.lua")
dofile_once("mods/conjurer_reborn/files/powers/toggle_kalma.lua")
dofile_once("mods/conjurer_reborn/files/powers/change_herd.lua")
dofile_once("mods/conjurer_reborn/files/powers/control_happiness.lua")
dofile_once("mods/conjurer_reborn/files/powers/grid_overlay.lua")
dofile_once("mods/conjurer_reborn/files/powers/binoculars.lua")
dofile_once("mods/conjurer_reborn/files/powers/waypoints.lua")
...
function render_world_menu()
  local conjurer_dimensions = {
    ...
    },
    {
      ...
      action=create_dimensional_portal(BIOME_FOREST, WORLD_CONJURER, "mods/conjurer_reborn/files/biomes/biome_map_green.png"),
    },
    {
      name="Aavikko",
    ...
    },
    {
      ...
      action=create_dimensional_portal(BIOME_HELL, WORLD_CONJURER, "mods/conjurer_reborn/files/biomes/biome_map_hellscape.png"),
    },
  }
  local noita_worlds = {
    {
