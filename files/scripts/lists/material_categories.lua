dofile_once("mods/conjurer_reborn/files/scripts/lists/solids.lua");
dofile_once("mods/conjurer_reborn/files/scripts/lists/sands.lua");
dofile_once("mods/conjurer_reborn/files/scripts/lists/liquids.lua");
dofile_once("mods/conjurer_reborn/files/scripts/lists/gases.lua");
dofile_once("mods/conjurer_reborn/files/scripts/lists/fires.lua");
dofile_once("mods/conjurer_reborn/files/scripts/lists/box2d_solids.lua");
dofile_once("mods/conjurer_reborn/files/scripts/lists/dangerous_materials.lua");
...
ALL_MATERIALS = {
  ...
  {
    name="Catastrophic",
    icon="mods/conjurer_reborn/files/gfx/matwand_icons/icon_dangerous.png",
    icon_off="mods/conjurer_reborn/files/gfx/matwand_icons/icon_dangerous_off.png",
    materials=DANGEROUS,
  },
};
...
dofile_once("mods/conjurer_reborn/files/scripts/lists/leftovers.lua");
if LEFTOVERS and #LEFTOVERS > 0 then
  table.insert(ALL_MATERIALS, {
    ...
    icon="mods/conjurer_reborn/files/gfx/matwand_icons/icon_leftovers.png",
    icon_off="mods/conjurer_reborn/files/gfx/matwand_icons/icon_leftovers_off.png",
    materials=LEFTOVERS,
  })
end
