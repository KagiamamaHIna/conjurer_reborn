        ...
        settings = {
			...
			Setting{
				...
				ui_fn = function(mod_id, gui, in_main_menu, im_id, setting)
                    ...
                    local click = GuiButton(gui, 1, 6, 0, GetTextOrKey("reset_matwand_fav"))
			...
			Setting{
				...
				ui_fn = function(mod_id, gui, in_main_menu, im_id, setting)
                    ...
                    local click = GuiButton(gui, 1, 6, 0, GetTextOrKey("reset_entwand_fav"))
                    local _, _, hover = GuiGetPreviousWidgetInfo(gui)
					--放开悬浮时重置
