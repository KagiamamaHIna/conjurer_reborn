...
ERASER_ICONS = {
  [ERASER_MODE_ALL]="mods/conjurer_reborn/files/gfx/matwand_icons/icon_erase_solids.png",
  [ERASER_MODE_SELECTED]="none, use active material",
  [ERASER_MODE_SOLIDS]="mods/conjurer_reborn/files/gfx/matwand_icons/icon_solid.png",
  [ERASER_MODE_LIQUIDS]="mods/conjurer_reborn/files/gfx/matwand_icons/icon_liquid.png",
  [ERASER_MODE_SANDS]="mods/conjurer_reborn/files/gfx/matwand_icons/icon_sand.png",
  [ERASER_MODE_GASES]="mods/conjurer_reborn/files/gfx/matwand_icons/icon_gas.png",
  [ERASER_MODE_FIRE]="mods/conjurer_reborn/files/gfx/matwand_icons/icon_fire.png",
}
...
function get_active_brush()
  ...
  local ALL_DRAWING_TOOLS = dofile("mods/conjurer_reborn/files/scripts/lists/brushes.lua")
