dofile_once("mods/conjurer_reborn/files/unsafe_gui/wands/mat_helper.lua")
...
local function CreateBrush(UI)
    ...
    if brush == 0 then
		...
		--材料检查
		local luacomp = {
			script_material_area_checker_success = "mods/conjurer_reborn/files/unsafe_gui/wands/checkmat.lua",
