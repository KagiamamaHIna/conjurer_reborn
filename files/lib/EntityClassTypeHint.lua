...
---@field mTargetPos field_vec2 Privates
---@field mTargetVec field_vec2 Privates
---@field mLastFramesMovementAreaMin field_vec2 Privates
---@field mLastFramesMovementAreaMax field_vec2 Privates
...
---@field mLastFramesMovementAreaMin field_vec2 Privates<br>---<br>AABB min of the area where we've been since the last time we got stuck
---@field mLastFramesMovementAreaMax field_vec2 Privates<br>---<br>AABB max of the area where we've been since the last time we got stuck
...
---@field mNextJumpTarget field_vec2 Privates<br>---<br>we use this for next jump
...
---@field mHomePosition field_vec2 Privates<br>---<br>where our home is located
...
---@field aabb_min field_vec2 Custom data types
---@field aabb_max field_vec2 Custom data types
...
---@field mRandomTarget field_vec2 Privates
---@field mLastLivingTargetPos field_vec2 Privates
...
---@field mPrevPos field_vec2 Privates
...
---@field mVelocity field_vec2 Privates
...
---@field mExAnimationPos field_vec2 Privates
...
---@field target_location field_vec2 Custom data types
...
---@field mAimingVector field_vec2 Privates
---@field mAimingVectorNormalized field_vec2 Privates<br>---<br>Aiming vector normalized to unit sphere.
---@field mAimingVectorNonZeroLatest field_vec2 Privates
---@field mGamepadAimingVectorRaw field_vec2 Privates
---@field mJumpVelocity field_vec2 Privates<br>---<br>used mostly by AI only?
---@field mMousePosition field_vec2 Privates
---@field mMousePositionRaw field_vec2 Privates
---@field mMousePositionRawPrev field_vec2 Privates
---@field mMouseDelta field_vec2 Privates
---@field mGamepadIndirectAiming field_vec2 Privates
---@field mGamePadCursorInWorld field_vec2 Privates<br>---<br>where the aiming cursor is in the world, updated by platformshooterplayer_system 
...
---@field mMin field_vec2 Privates
---@field mMax field_vec2 Privates
---@field mPrevNonSnappedPosition field_vec2 Privates
---@field mPrevCellPosition field_ivec2 Privates
---@field mPrevCellPosition2 field_ivec2 Privates
---@field mPrevCellPosition3 field_ivec2 Privates
---@field mPrevCellPosition4 field_ivec2 Privates
---@field mPrevCellPosition5 field_ivec2 Privates
---@field mPrevCellPosition6 field_ivec2 Privates
---@field mPrevCellPosition7 field_ivec2 Privates
---@field mPrevCellPosition8 field_ivec2 Privates
---@field mLatestPosition field_ivec2 Privates
...
---@field mPhysicsDamageVecThisFrame field_vec2 Privates<br>---<br>direction of physics damage
...
---@field mAvgDir field_vec2 Privates
---@field mPrevPos field_ivec2 Privates
...
---@field mPrevPosition field_vec2 Privates
...
---@field aabb_min field_vec2 Custom data types
---@field aabb_max field_vec2 Custom data types
---@field velocity field_vec2 Privates
---@field stuck_counter integer Privates
---@field mLastCheckPos field_vec2 Privates
...
---@field offset field_vec2 Custom data types
...
---@field mTarget field_vec2 Custom data types
...
---@field end_position field_vec2 Custom data types
---@field mJointWorldPos field_vec2 Custom data types
---@field mEndPrevPos field_vec2 Custom data types
---@field mPart0PrevPos field_vec2 Privates
---@field mPart0PrevRotation number Privates
---@field mPart1PrevPos field_vec2 Privates
...
---@field mTarget field_vec2 Custom data types
---@field mPrevTarget field_vec2 Custom data types
---@field mPrevCenterPosition field_vec2 Custom data types
...
---@field ray_skip_material integer Custom data types<br>---<br>String name of material to not cast rays against. Defaults to 'aluminium'
---@field mPrevBodyPosition field_vec2 Custom data types
...
---@field mSmoothedItemAngleVec field_vec2 Privates
...
---@field ui_container_size field_ivec2 Custom data types<br>---<br>ui size, how many items x*y we can fit in
---@field ui_element_size field_ivec2 Custom data types<br>---<br>ui size
---@field ui_position_on_screen field_ivec2 Custom data types<br>---<br>where do we load this on screen
...
---@field spawn_pos field_vec2 Custom data types<br>---<br>the position where this item spawned
...
---@field inventory_slot field_ivec2 Custom data types<br>---<br>our preferred slot (x,y) in the inventory
...
---@field mLatestItemOverlapInfoBoxPosition field_vec2 Custom data types
...
---@field mExPosition field_vec2 Privates<br>---<br>stores the ex position of this entity
---@field mArcTarget integer Privates<br>---<br>if 'mArcTarget' points to an existing entity a lighting arc will be created between this entity and 'mArcTarget'
...
---@field ex_position field_vec2 Privates<br>---<br>used to figure out movement velocity
...
---@field size field_ivec2 Custom data types<br>---<br>Size of the area to cover
---@field offset field_ivec2 Custom data types<br>---<br>Offset of the center of the area to cover
...
---@field gravity field_vec2 Custom data types
---@field count_min integer Custom data types
---@field count_max integer Custom data types
---@field mExPosition field_vec2 Privates<br>---<br>is used with is_trail
...
---@field m_last_emit_position field_ivec2 Privates
...
---@field path_next_node_vector_to field_vec2 Privates<br>---<br>TODO: Comment
...
---@field mLastPositionWhenHadPath field_vec2 Privates
...
---@field mLocalPosition field_vec2 Custom data types<br>---<br>private variable, please don't mess around with this
...
---@field mActiveState boolean Members<br>---<br>private variable, please don't mess around with this
---@field initial_velocity field_vec2 Custom data types<br>---<br>if you want a velocity at the start, set it here
---@field mBody unsupported Privates
...
---@field mExPosition field_vec2 Privates
...
---@field transform unsupported Custom data types
---@field original_left_joint_pos field_vec2 Custom data types
---@field original_right_joint_pos field_vec2 Custom data types
---@field isBroken boolean Privates
---@field leftJointPos field_vec2 Privates
---@field rightJointPos field_vec2 Privates
...
---@field eating_area_min field_ivec2 Custom data types
---@field eating_area_max field_ivec2 Custom data types
---@field mSmoothedCameraPosition field_vec2 Privates
---@field mSmoothedAimingVector field_vec2 Privates
...
---@field mDesiredCameraPos field_vec2 Privates
...
---@field mCamCorrectionGainSmoothed field_vec2 Privates
---@field mCameraErrorPrev unsupported Privates
---@field mCamErrorAveraged field_vec2 Privates
...
---@field shell_casing_offset field_vec2 Custom data types<br>---<br>where the shell casing will be created relative to projectile, y is flipped if projectile direction is to the left.
...
---@field velocity field_vec2 Custom data types<br>---<br>This is added together with random velocity
...
---@field mOldPosition field_vec2 Privates<br>---<br>used for box2d simple physics
...
---@field transform_offset field_vec2 Custom data types
---@field offset_animator_offset field_vec2 Custom data types<br>---<br>used by SpriteOffsetAnimator
---@field mSprite unsupported Privates
...
---@field velocity field_vec2 Custom data types<br>---<br>original velocity
---@field gravity field_vec2 Custom data types<br>---<br>gravity
---@field scale field_vec2 Custom data types<br>---<br>original scale
---@field scale_velocity field_vec2 Custom data types<br>---<br>scale velocity per second
---@field randomize_lifetime unsupported Custom data types<br>---<br>this is added to the lifetime
...
---@field expand_randomize_position field_vec2 Custom data types<br>---<br>will add dt*this to randomize_position_aabb every frame
...
---@field target field_vec2 Custom data types<br>---<br>Where should we teleport
...
---@field mVelocity field_vec2 Custom data types
---@field mPrevVelocity field_vec2 Privates<br>---<br>used to update physics bodies
---@field mLatestLiquidHitCount integer Privates
---@field mAverageLiquidHitCount integer Privates
---@field mPrevPosition field_ivec2 Privates
...
---@field animation_target_offset field_vec2 Custom data types
---@field cloth_color_edge unsupported Custom data types
---@field cloth_color unsupported Custom data types
---@field m_position_previous field_vec2 Custom data types
...
---@field world_position field_vec2 Custom data types<br>---<br>Where we attach the verlet point
...
---@field player_spawn_location field_vec2 Custom data types
...
---@field mPrevPosition field_vec2 Privates
---@field mDirection field_vec2 Privates<br>---<br>if mDirection == 0,0 nothings works
