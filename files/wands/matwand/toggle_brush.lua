...
function create_brush()
  ...
  EntityLoad("mods/conjurer_reborn/files/wands/matwand/brushes/brush_reticle.xml", x, y)
  EntityLoad("mods/conjurer_reborn/files/wands/matwand/brushes/eraser_reticle.xml", x, y)
