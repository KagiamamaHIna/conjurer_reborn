...
BACKGROUNDS = {
  ...
  },
  {
    ...
    image="mods/conjurer_reborn/files/gfx/bg_icons/83_horizontalobservatory3_background.png",
  ...
  },
  {
    ...
    image="mods/conjurer_reborn/files/gfx/bg_icons/84_horizontalobservatory_background.png",
  ...
  },
  {
    ...
    image="mods/conjurer_reborn/files/gfx/bg_icons/85_puzzle_capsule_b_background.png",
    spawn_func=spawn_img("data/biome_impl/snowcave/puzzle_capsule_b_background.png", 62, 248),
  },
  {
    name="Puzzle capsule background",
    image="mods/conjurer_reborn/files/gfx/bg_icons/86_puzzle_capsule_background.png",
    spawn_func=spawn_img("data/biome_impl/snowcave/puzzle_capsule_background.png", 5, 18),
  },
  {
    name="Receptacle water background",
    image="mods/conjurer_reborn/files/gfx/bg_icons/87_receptacle_water_background.png",
    spawn_func=spawn_img("data/biome_impl/snowcave/receptacle_water_background.png", 57, 386),
  },
  {
    name="Snowcastle background",
    image="mods/conjurer_reborn/files/gfx/bg_icons/88_snowcastle_background.png",
    spawn_func=spawn_img("data/biome_impl/snowcave/snowcastle_background.png", 46, 37),
  },
  {
    name="Tinyobservatory2 background",
    image="mods/conjurer_reborn/files/gfx/bg_icons/89_tinyobservatory2_background.png",
    spawn_func=spawn_img("data/biome_impl/snowcave/tinyobservatory2_background.png", 37, 12),
  },
  {
    name="Tinyobservatory background",
    image="mods/conjurer_reborn/files/gfx/bg_icons/90_tinyobservatory_background.png",
    spawn_func=spawn_img("data/biome_impl/snowcave/tinyobservatory_background.png", 6, 7),
  },
  {
    name="Verticalobservatory2 background",
    image="mods/conjurer_reborn/files/gfx/bg_icons/91_verticalobservatory2_background.png",
